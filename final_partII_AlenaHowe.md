...
*Post-Interview Changes*
  ...
  - I also want to experiment with a map that shows museum revenue by state. Looking at revenue helps show how much support these institutions have. Including this map would help show the correlation between population and revenue (support). This is further illustrated by the scatterplot.
  - 
  I'll continue to explore museum revenue by changing the stacked bar chart to reflect the proportion of revenue that each type of museum brings in by region. 
