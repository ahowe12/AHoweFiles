...
- Based on the feedback from the people who I interviewed, I'm going to focus my story on targeting the general public (as opposed to museum professionals). My visualizations will address misconceptions about what institutions make up the museum sector, where these institutions are located, how much support they receive (measured in revenue), and how much these nonprofits actually profits from their activities (measured in income). 
...
- In my original wireframes, I began with a bar chart that shows the number of museums by discipline. The goal of this visualziation is to address the general public's misconceptions about what types of institutions are categorized as museums. Three of the four people who I intereviewed found this visualization to be informative. The fourth person said that she doesn't care what institutions make up the sector; she wants to see more information about funding and participation. I'm looking into what data exists haven't had any luck finding comprehensive data sets. I can either 1) eliminate this visualization and summarize the sector in the introductory slide or 2) keep the visualization and provide a clear explanation of why this data is important. I can also experiment with displaying this data as a treemap chart. 
- I'm going to make the US map of museums per capita the first visualization and create filters for each of the museum disciplines. I'll provide an explanation of how the most and least vibrant states change depending on whether historical societies and general museums are counted. 
- I also want to experiment with a map that shows museum revenue by state. Looking at revenue helps show how much support these institutions have in different areas of the country. Including this map would help show the correlation between population and revenue. This is further illustrated by the scatterplot visualization.
- Instead of the stacked bar chart that shows museum disciplines by region, I'm going to create visualization that focuses on the top 5 and least 5 vibrant states. For instance, I'm going to create a stacked graph that shows the breakdown of museums per capita by locale code (like city, suburb, town, rural). This will help answer the question: do people in less urban areas have equal access per captia as those living in urban areas? I'm also interested in creating a visualization that shows museum income (distributed across 5-6 income brackets) for the most and least vibrant states. 
